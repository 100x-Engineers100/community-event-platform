...
function LoginForm() {
  ...
  return (
    <Card className="w-full max-w-md border-[#2A2A2A]">
      <CardHeader className="text-center space-y-4">
        <div className="flex justify-center">
          <div className="text-4xl font-bold text-[#F96846]">100x</div>
        </div>
        <CardTitle className="text-2xl">Engineers Events</CardTitle>
        <CardDescription className="text-[#A0A0A0]">
          Sign in to host or join community events
        </CardDescription>
      </CardHeader>
    ...
    <div className="flex min-h-screen items-center justify-center p-4">
      <Suspense fallback={
        <Card className="w-full max-w-md border-[#2A2A2A]">
          ...
          <CardContent>
            <div className="h-10 bg-[#1A1A1A] animate-pulse rounded-md" />
          </CardContent>
        </Card>
      }>
        <LoginForm />
